...
| `interface.rhm` | Roles, directional interfaces, single-parent nominal refinement, public endpoint annotations, and bulk connection | core IR, kernel, field support, instance-member support |
