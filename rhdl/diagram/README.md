<!-- Describes RHDL's read-only logical block and flow visualization package. -->

# Logical circuit diagrams

`rhdl/diagram` builds a tool-neutral logical view from a verified
...
```rhombus
import lib("rhdl/diagram/main.rhm") open
