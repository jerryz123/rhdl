// Verifies Ricket drains older work and takes a machine interrupt precisely.
module ricket_interrupt_tb;
      ...
      if (data_access_out.request.valid && data_access_in.request.ready) begin
        ...
        case (data_access_out.request.bits.address)
          ...
          64'd32: begin
            ...
            $display("Ricket precise machine interrupt delivery passed");
            $finish;
          end
