...
(("bad-input-drive.rhdl" "connection target must be a driveable hardware place")
 ...
 ("bad-parameter.rhdl" "circuit parameter 0 must be a CircuitParam, not hardware")
 ("bad-register-parameter.rhdl" "circuit parameter 0 must be a CircuitParam, not hardware")
 ...
 ("bad-interface-parameter.rhdl" "circuit parameter 0 must be a CircuitParam, not hardware")
