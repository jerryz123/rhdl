...
expect_failure bad-or-reduce-type.rhdl "or_reduce operand must have a packable DataType"
expect_failure bad-and-reduce-type.rhdl "and_reduce operand must have a packable DataType"
