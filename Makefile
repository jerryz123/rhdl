...
examples:
	...
	racket -S $(CURDIR) examples/one-hot.rhdl
	...
	racket -S $(CURDIR) examples/nested-circuit.rhdl
	...
	racket -S $(CURDIR) examples/clocked-dpi.rhdl
