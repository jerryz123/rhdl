...
ricket-test: ricket-host-test
	FIXTURES='rv32i-alu rv64i-alu rv64i-alu-decode rv64i-alu-integrated load-store iterative-multiplier iterative-divider scoreboard ricket-register-file ricket-csr ricket-core ricket-core-flow ricket-multiply ricket-divide ricket-core-rv32 ricket-icache ricket-dcache ricket-dcache-rv32' bash tests/backend/run-circt.sh
